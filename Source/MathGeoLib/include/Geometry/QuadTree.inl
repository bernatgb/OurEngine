...
{
	//return (std::max<int>)(0, nodes.size() - 3); // MATHGEOLIB ERROR
	return (0 > nodes.size() - 3) ?  0 : nodes.size() - 3; // The nodes rootNodeIndex+1, rootNodeIndex+2 and rootNodeIndex+3 are dummy unused, since the root node is not a quadrant.
}
